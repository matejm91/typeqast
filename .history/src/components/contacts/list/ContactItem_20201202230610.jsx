            ...
            <Row type="flex" justify="space-around" className="typeqast-contactList__actionsRow">
              <Col xs={{ span: 8}} md={{ span: 3}}>
                <Icon
                  ...
                  onClick={(e) => thishandleFavorite(e, this.props.contact.id)}
                />
              </Col>
              <Col xs={{ span: 8}} md={{ span: 3, offset: 15 }}>
                <Icon
                  ...
                  type="edit"
                  onClick={(e) => thishandleEdit(e, this.props.contact.id)}
                />
              </Col>
              <Col xs={{ span: 8}} md={{ span: 3}}>
                <Icon
                  ...
                  type="delete"
                  onClick={(e) => thishandleToggleDelete(e, this.props.contact.id)}
                />
              </Col>
            </Row>
            <Row
              ...
              justify="center"
              align="middle"
              onClick={(e) => thishandleContactClick(e, this.props.contact.id)}
            >
              <img
