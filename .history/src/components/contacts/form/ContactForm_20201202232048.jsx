          ...
          <Row type='flex' justify='center'>
            ...
            <Col span={13} className='typeqast-contactForm__contactInfo'>
              <Row type='flex' justify='space-between'>
                <Col>
                  <Icon className='typeqast-contactForm__actionIcon' type="arrow-left" onClick={this.handleBackClick} />
                </Col>
                {this.props.onDelete && <Col>
                  <Row type='flex' justify='space-between' onClick={this.handleDelete}>
                    <Col>
                      <p className='typeqast-contactForm__deleteButtonLabel'>Delete</p>
                    </Col>
                    <Col>
                      <Icon className='typeqast-contactForm__actionIcon' type="delete"/>
                    </Col>
                  </Row>
                </Col>}
              </Row>
